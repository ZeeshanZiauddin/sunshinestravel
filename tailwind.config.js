...
export default {
    ...
    theme: {
        ...
        extend: {
            backgroundImage: {
                "hero-morning": "url('/images/hero/hero_1.jpg')",
                "hero-afternoon": "url('/images/hero/hero_2.jpg')",
                "hero-evening": "url('/images/hero/hero_3.jpg')",
                "hero-night": "url('/images/hero/hero_4.jpg')",
            },
            colors: {
                black: "#212b36",
                "dark-700": "#090e34b3",
