<x-layout>
    <!-- ====== Hero Section Start -->
    <x-hero :destinations="$destinations" />
    <!-- ====== Hero Section End -->
    <x-marque />
    ...
    <!-- ====== CTA Section Start -->
    <section class="relative z-10 overflow-hidden bg-hero-evening bg-cover  py-20 lg:py-[115px]">

        <div class="absolute inset-0 bg-blue-950 bg-opacity-65">
