            ...
            <div class="w-full px-4">
                <div class="mx-auto mb-12 max-w-[485px] text-center lg:mb-[70px]">
                    ...
                    <h2
                        ...
                        Services We Provide at Sunshine Travels
                    </h2>
                    <p class="text-base text-body-color dark:text-dark-6">
                        At Sunshine Travels, we are dedicated to offering seamless travel experiences for our customers.
                        Whether you are traveling for business, leisure, or family purposes, our services are tailored
                        to meet your needs. Here's what we offer:
                    </p>
                </div>
            </div>
        </div>
        <div class="-mx-4 flex flex-wrap">
            <div class="w-full px-4 md:w-1/2 lg:w-1/4">
                <div class="wow fadeInUp group mb-12" data-wow-delay=".1s">
                    ...
                    <p class="mb-8 text-body-color dark:text-dark-6 lg:mb-9">
                        From historical explorations to beach getaways in Sierra Leone, we design personalized tour
                        packages to give you memorable travel experiences.
                    </p>
            ...
            <div class="w-full px-4 md:w-1/2 lg:w-1/4">
                <div class="wow fadeInUp group mb-12" data-wow-delay=".15s">
                    ...
                    <h4 class="mb-3 text-xl font-bold text-dark dark:text-white">
                        Exclusive Offers for African Travelers
                    </h4>
                    <p class="mb-8 text-body-color dark:text-dark-6 lg:mb-9">
                        With a focus on travelers in Africa and Europe, we understand your unique needs and offer
                        specialized packages tailored just for you.
                    </p>
            ...
            <div class="w-full px-4 md:w-1/2 lg:w-1/4">
                <div class="wow fadeInUp group mb-12" data-wow-delay=".2s">
                    ...
                    <p class="mb-8 text-body-color dark:text-dark-6 lg:mb-9">
                        Our dedicated team is available round the clock to assist with inquiries, changes to bookings,
                        or any travel-related concerns.
                    </p>
            ...
            <div class="w-full px-4 md:w-1/2 lg:w-1/4">
                <div class="wow fadeInUp group mb-12" data-wow-delay=".25s">
                    ...
                    <p class="mb-8 text-body-color dark:text-dark-6 lg:mb-9">
                        We specialize in affordable flights between the UK and Sierra Leone, ensuring you get the best
                        deals on airfares. With a user-friendly process and dedicated support, your journey starts
                        stress-free.
                    </p>
