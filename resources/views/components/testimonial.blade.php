            ...
            <div class="w-full px-4">
                <div class="mx-auto mb-[60px] max-w-[485px] text-center">
                    ...
                    <p class="text-base text-body-color dark:text-dark-6">
                        Don't believe our word, See what our most happy customers have to say about our services.
                    </p>
                </div>
            </div>
        </div>
                ...
                <div class="swiper-wrapper">
                    <div class="swiper-slide">
                        <div class="rounded-xl bg-white px-4 py-[30px] shadow-testimonial dark:bg-dark sm:px-[30px]">
                            ...
                            <p class="mb-6 text-base text-body-color dark:text-dark-6">
                                "Sunshine Travels made my trip to Sierra Leone so smooth! The customer service was
                                excellent, and I felt safe and comfortable the entire time. Highly recommend for
                                anyone traveling to Africa."
                            </p>

                            <a href="#" class="flex items-center gap-4">
                                <div class="h-[50px] w-[50px] overflow-hidden rounded-full">
                                    <img src="images/testimonials/author-01.jpg" alt="author"
                                ...
                                <div>
                                    ...
                                    <p class="text-xs text-body-secondary">Founder @ Global Solutions</p>
                                </div>
                            </a>
                        </div>
                    </div>
                    ...
                    <div class="swiper-slide">
                        <div class="rounded-xl bg-white px-4 py-[30px] shadow-testimonial dark:bg-dark sm:px-[30px]">
                            ...
                            <p class="mb-6 text-base text-body-color dark:text-dark-6">
                                "I used Sunshine Travels for my flight from Europe to Africa, and the whole process
                                was flawless. From booking to landing, everything was professionally handled. I felt
                                at ease traveling with them."
                            </p>

                            <a href="#" class="flex items-center gap-4">
                                <div class="h-[50px] w-[50px] overflow-hidden rounded-full">
                                    <img src="images/testimonials/author-02.jpg" alt="author"
                                        class="h-[50px] w-[50px] overflow-hidden rounded-full" />
                                </div>
                                ...
                                <div>
                                    ...
                                    <p class="text-xs text-body-secondary">Digital Nomad</p>
                                </div>
                            </a>
                        </div>
                    </div>
                    ...
                    <div class="swiper-slide">
                        <div class="rounded-xl bg-white px-4 py-[30px] shadow-testimonial dark:bg-dark sm:px-[30px]">
                            ...
                            <p class="mb-6 text-base text-body-color dark:text-dark-6">
                                "As a frequent traveler to Africa, Sunshine Travels is my go-to agency. They provide
                                excellent services, and their attention to detail makes the journey smooth and
                                hassle-free. I trust them with all my travel needs."
                            </p>

                            <a href="#" class="flex items-center gap-4">
                                <div class="h-[50px] w-[50px] overflow-hidden rounded-full">
                                    <img src="images/testimonials/author-03.jpg" alt="author"
                                        class="h-[50px] w-[50px] overflow-hidden rounded-full" />
                                </div>
                                ...
                                <div>
                                    ...
                                    <p class="text-xs text-body-secondary">Travel Blogger @ AfricaExplorer</p>
                                </div>
                            </a>
                        </div>
                    </div>
