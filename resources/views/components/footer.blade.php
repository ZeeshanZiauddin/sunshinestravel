        ...
        <div class="-mx-4 flex flex-wrap">
            ...
            <div class="w-full px-4 sm:w-1/2 md:w-1/2 lg:w-2/12 xl:w-2/12">
                <div class="mb-10 w-full">
                    ...
                    <ul>
                        ...
                        <li>
                            <a href="/contact" class="mb-3 inline-block text-base text-gray-7 hover:text-primary">
                                Testimonial
                            </a>
                        </li>
                    </ul>
            ...
            <div class="w-full px-4 sm:w-1/2 md:w-1/2 lg:w-3/12 xl:w-2/12">
                <div class="mb-10 w-full">
                    ...
                    <ul>
                        <li>
                            <a href="/airlines" class="mb-3 inline-block text-base text-gray-7 hover:text-primary">
                                Airlines
                            </a>
                        </li>
                        <li>
            ...
            <div class="w-full px-4 md:w-2/3 lg:w-6/12 xl:w-3/12 text-white">
                <div>
                    ...
                    <p class="mb-4 flex items-center justify-center md:justify-start">
                        ...
                        info@globaltoursandtravels.co.uk
                    </p>
                    <p class="mb-4 flex items-center justify-center md:justify-start">
                        <span class="me-3 [&>svg]:h-5 [&>svg]:w-5">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
                    ...
                    <p class="mb-4 flex items-center justify-center md:justify-start">
                        ...
                        123 Regent Street, London, W1B 4HD, United Kingdom
                ...
                <div class="w-full px-4 md:w-1/3 lg:w-1/2">
                    <div class="my-1 flex justify-center md:justify-end">
                        <p class="text-base text-gray-7">
                            ...
                            <a href="https://www.linkedin.com/in/zeeshan-ziauddin/" rel="nofollow noopner"
