            ...
            <div class="w-full px-4">
                <div class="mx-auto mb-[60px] max-w-[520px] text-center">
                    ...
                    <p class="mx-auto max-w-[485px] text-base text-body-color dark:text-dark-6">
                        Any Questions in mind you'll most likelly find answers below if not contact us directly.
                    </p>
                </div>
            </div>
        </div>
            ...
            <div class="w-full px-4 lg:w-1/2">
                <div class="mb-12 flex lg:mb-[70px]">
                    ...
                    <div class="w-full">
                        <h3
                            ...
                            How can I book a flight from the UK to Sierra Leone with Sunshine Travels?
                        </h3>
                        <p class="text-base text-body-color dark:text-dark-6">
                            Booking a flight to Sierra Leone from the UK is simple with Sunshine Travels. You can
                            visit our website, select your desired travel dates, and choose from the most affordable
                            and convenient flight options available. Our customer support team is also ready to
                ...
                <div class="mb-12 flex lg:mb-[70px]">
                    ...
                    <div class="w-full">
                        <h3
                            class="mb-6 text-xl font-semibold text-dark dark:text-white sm:text-2xl lg:text-xl xl:text-2xl">
                            What are the benefits of flying with Sunshine Travels between Europe and Africa?

                        </h3>
                        <p class="text-base text-body-color dark:text-dark-6">
                            Sunshine Travels provides excellent customer service, comfortable flights, and
                            competitive pricing for travelers between Europe and Africa. We ensure that all bookings
                            are handled smoothly and efficiently, with options for direct and layover flights, so
            ...
            <div class="w-full px-4 lg:w-1/2">
                <div class="mb-12 flex lg:mb-[70px]">
                    ...
                    <div class="w-full">
                        <h3
                            class="mb-6 text-xl font-semibold text-dark dark:text-white sm:text-2xl lg:text-xl xl:text-2xl">
                            What are the best flight routes from the UK to Africa?
                        </h3>
                        <p class="text-base text-body-color dark:text-dark-6">
                            Some of the best flight routes from the UK to Africa include direct flights to Sierra
                            Leone, Nigeria, Ghana, Kenya, and South Africa. Sunshine Travels works with major
                            airlines to provide travelers with options that are both affordable and timely. Contact
                            us to find the most suitable flight route for your destination.
                        </p>
                    </div>
                </div>
                <div class="mb-12 flex lg:mb-[70px]">
                    ...
                    <div class="w-full">
                        <h3
                            class="mb-6 text-xl font-semibold text-dark dark:text-white sm:text-2xl lg:text-xl xl:text-2xl">
                            Can Sunshine Travels help with visa requirements for travel to Africa?
                        </h3>
                        <p class="text-base text-body-color dark:text-dark-6">
                            Yes, Sunshine Travels can assist with general information regarding visa requirements
                            for African destinations. While we don’t handle the application process, we guide you on
                            the necessary steps to take before your flight, ensuring your trip is smooth and
                            hassle-free.
                        </p>
                    </div>
            ...
            <div class="w-full px-4 lg:w-1/2">
                ...
                <div class="mb-12 flex lg:mb-[70px]">
                    ...
                    <div class="w-full">
                        <h3
                            class="mb-6 text-xl font-semibold text-dark dark:text-white sm:text-2xl lg:text-xl xl:text-2xl">
                            Are there any special offers for flights to Africa from the UK?
                        </h3>
                        <p class="text-base text-body-color dark:text-dark-6">
                            Sunshine Travels frequently offers special deals and discounts on flights from the UK to
                            Africa. Be sure to sign up for our newsletter or check our website regularly to get the
                            latest offers and promotions, ensuring you get the best value for your travel.
                        </p>
                    </div>
                </div>
            </div>
            <div class="w-full px-4 lg:w-1/2">
                ...
                <div class="mb-12 flex lg:mb-[70px]">
                    ...
                    <div class="w-full">
                        <h3
                            class="mb-6 text-xl font-semibold text-dark dark:text-white sm:text-2xl lg:text-xl xl:text-2xl">
                            How can I make changes to my flight booking with Sunshine Travels?
                        </h3>
                        <p class="text-base text-body-color dark:text-dark-6">
                            You can easily modify your flight booking through our customer support or online portal. If
                            your travel plans change, our team is here to help you make adjustments to your flight,
                            whether it’s changing your dates or upgrading your seat.
                        </p>
                    </div>
                </div>
            </div>
            <div class="w-full px-4 lg:w-1/2">
                ...
                <div class="mb-12 flex lg:mb-[70px]">
                    ...
                    <div class="w-full">
                        <h3
                            class="mb-6 text-xl font-semibold text-dark dark:text-white sm:text-2xl lg:text-xl xl:text-2xl">
                            Can I book group flights with Sunshine Travels to Africa?
                        </h3>
                        <p class="text-base text-body-color dark:text-dark-6">
                            Yes, Sunshine Travels offers group flight bookings for families, businesses, or other groups
                            traveling from the UK to Africa. Our team can help arrange customized itineraries and
                            competitive group rates, ensuring your entire party enjoys a comfortable and affordable
                            journey.
                        </p>
                    </div>
                </div>
